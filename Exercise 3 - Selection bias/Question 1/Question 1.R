...
#####################################################################################
#####################################################################################
### How could you assign specific values to the selection probabilities below? ######
#####################################################################################
#####################################################################################

S_dis_exp #TO COMPLETE             #VALUE FOR SELECTION PROBABILITY IN D+E+ INDIVIDUALS 
S_dis_unexp #TO COMPLETE		        #VALUE FOR SELECTION PROBABILITY IN D+E- INDIVIDUALS  
S_undis_exp #TO COMPLETE		        #VALUE FOR SELECTION PROBABILITY IN D-E+ INDIVIDUALS 
S_undis_unexp #TO COMPLETE		      #VALUE FOR SELECTION PROBABILITY IN D-E- INDIVIDUALS 


# Specify the model ------------------------------------------------------

############################################################################################
### Complete the model below to assign specific values to the selection probabilities ######
############################################################################################
...
#===	PRIORS	===#		
			...
			##################################################################
			### COMPLETE FOR THE 4 SELECTION PROBABILITIES. HOW COULD YOU ####
			### ASSIGN A VALUE FOR EACH OF THESE?                         ####   
      ##################################################################
		}")
...
############################################################################################
### Complete the initial values below                                                 ######
############################################################################################
