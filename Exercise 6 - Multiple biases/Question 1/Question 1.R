...
#############################################################################
### We completed most of the model, just complete the likelihood function ###
### and the extra setps need to compute the adjusted ORs                  ###
#############################################################################
...
##############################################################
### Complete the parameters that you would like to monitor ###
##############################################################

bug.out.mult <- bugs(data=cyst, 
                             inits=inits, 
                             parameters.to.save=c("int", "betaquest", ###TO COMPLETE###),
                             n.iter=niterations, 
                             n.burnin=0, 
                             n.thin=1,
                             n.chains=3, 
